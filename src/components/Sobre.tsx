      ...
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-4 text-lg text-muted">
          ...
          <span className="italic">
            [PLACEHOLDER: complementar com a história real — quando abriu, o
            que motivou, algum diferencial marcante]
          </span>{" "}
          pra servir o hambúrguer artesanal que a gente gostaria de comer.
        </p>
      </div>
    </section>
  );
